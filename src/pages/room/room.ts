...
export class RoomPage implements OnInit {
	...
	stageClick(e: MouseEvent) {
		...
		console.log(sec);
		this.navCtrl.push(IssuePage, { projid: this.projid, batchid: this.batchid, buildingid: this.buildingid, buildingname: this.buildingname, roomid: this.roomid, roomname: this.roomname, x: cX, y: cY, section: sec, areas: this.dwgInfo.areas, type: this.type });
	}
